 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "This notebook runs the complete MagicFace pipeline (preprocess, retrieve_bg, and inference) on 50 images from `processed_identities`."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "    # 3. Inference (Angry Face)\n",
    "    print(\"Step 3: Inference (Angry)\")\n",
    "    cmd3 = f\"{PYTHON_PATH} inference.py --img_path {cropped_image} --bg_path {bg_image} --au_test AU4+AU5 --AU_variation 5+5 --saved_path {OUTPUT_DIR}\"\n",
...
with open("c:/Users/faris3/MagicFace/batch_process.ipynb", "w", encoding="utf-8") as f:
