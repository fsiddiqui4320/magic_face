...
|------------|-----|------------|-------|
| Angry | `AU4+AU5+AU25+AU12` | `5+4+-2+-2` | AU4 lowers inner brow; AU5=4 keeps eyes open (AU5=3 causes distortion — too much AU4 sadness droop); AU25=-2 closes lips; AU12=-2 tightens lip corners (approximates AU23). AU2 excluded — causes eye distortion at any negative value tested (-1 and -2 both distort). |
